...
sizes=size(image);
sizes2=size(result);
set(gca,'xtick',[sizes(2)+0.5:sizes(2):sizes2(2)+0.5],'ytick',[sizes(1)+0.5:sizes(1):sizes2(1)+0.5],'xcolor',[1 1 1],'ycolor',[1 1 1],'yticklabel',[],'xticklabel',[],'gridlinestyle','-','MinorGridLineStyle','-');
grid on;
