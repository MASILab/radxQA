function [PSG,pf_hdl]=PercentSignalGhosting_EPI(img,reso,slice)
...
[centre_coord_2,contour_xy_2,I_bin_2]=MakeEllipseROI_EPI(I,ind_centre,ind_col_low,0,[w_pxl,l_pxl],pxl_sz,2);
[centre_coord_3,contour_xy_3,I_bin_3]=MakeEllipseROI_EPI(I,ind_centre,ind_col_high,FOV_row,[w_pxl,l_pxl],pxl_sz,3);
[centre_coord_4,contour_xy_4,I_bin_4]=MakeEllipseROI_EPI(I,ind_centre,ind_row_low,0,[w_pxl,l_pxl],pxl_sz,4);
[centre_coord_5,contour_xy_5,I_bin_5]=MakeEllipseROI_EPI(I,ind_centre,ind_row_high,FOV_col,[w_pxl,l_pxl],pxl_sz,5);
...
if I_ROI_2_mean==0 || isnan(I_ROI_2_mean); I_ROI_2_mean=I_ROI_3_mean; end
if I_ROI_3_mean==0 || isnan(I_ROI_3_mean); I_ROI_3_mean=I_ROI_2_mean; end
if I_ROI_4_mean==0 || isnan(I_ROI_4_mean); I_ROI_4_mean=I_ROI_5_mean; end
if I_ROI_5_mean==0 || isnan(I_ROI_5_mean); I_ROI_5_mean=I_ROI_4_mean; end
